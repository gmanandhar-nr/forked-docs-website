...
Make sure you have the necessary minimum versions for your <InlinePopover type="browser"/> agent and your <InlinePopover type="apm"/> agent:
...
2. Go to <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Browser > (select an app) > Settings > Application settings**</DNT>.
3. Turn on the <DNT>**Distributed tracing**</DNT> toggle.
...
2. Configure browser monitoring in your <DNT>**Application settings**</DNT> to include the target origin in distributed tracing.
