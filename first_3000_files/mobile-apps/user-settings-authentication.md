---
title: Authenticate your New Relic mobile app account
tags:
  - Mobile apps
...
<CollapserGroup>
      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            1. Log out from the Android device: <DNT>**Main menu > (selected username) > Logout > Confirm**</DNT>.
        ...
        <tr>
          ...
          <td>
            1. From the app menu, select your account name, then select the <DNT>**Users**</DNT> menu.
            2. From the <DNT>**Users**</DNT> menu, select the plus <Icon name="fe-plus-circle"/> icon.
        ...
        <tr>
          ...
          <td>
            1. To access the <DNT>**Users**</DNT> menu: Select the user icon <img style={{ width: '25px', height: '24px'}} class="inline" title="icon-ios-app-user" alt="icon-ios-app-user" src="/images/mobile-apps_icon_user.webp"/> or slide right.
            2. From the <DNT>**Users**</DNT> menu, select the plus <Icon name="fe-plus-circle"/> icon.
            3. Sign in with the additional username.
          </td>
        </tr>
  ...
  >
    ...
    1. From the <DNT>**Users**</DNT> menu, select the user name.
