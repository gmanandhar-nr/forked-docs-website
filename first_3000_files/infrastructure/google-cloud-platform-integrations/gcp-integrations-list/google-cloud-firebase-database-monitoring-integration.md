...
To enable the integration follow standard procedures to [connect your GCP service to New Relic infrastructure monitoring](/docs/connect-google-cloud-platform-services-infrastructure).
