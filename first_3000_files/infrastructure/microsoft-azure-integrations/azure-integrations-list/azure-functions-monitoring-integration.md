...
To find your integration data, go to <DNT>**[one.newrelic.com](https://one.newrelic.com/all-capabilities)**</DNT>, in the top nav click <DNT>**Infrastructure**</DNT>, then click <DNT>**Azure**</DNT> and look for the integration.
