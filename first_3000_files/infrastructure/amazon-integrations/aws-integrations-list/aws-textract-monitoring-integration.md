...
[New Relic infrastructure integrations](/docs/infrastructure/introduction-infra-monitoring) now include an integration for <DNT>AWS Textract</DNT>, sending its metrics data to New Relic.
...
Data from this integration is attached to the `Metric` data type. To find your integration's metrics, go to <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Metrics and events**</DNT> and filter by `aws.textract`.
