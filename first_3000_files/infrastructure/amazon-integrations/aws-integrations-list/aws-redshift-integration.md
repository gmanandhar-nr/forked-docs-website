...
To allow New Relic to access Redshift data, your AWS account must have the <DNT>**ReadOnly**</DNT> policy associated with it, or the following permissions must be granted to your New Relic account:
...
To find your integration data, go to <DNT>**[one.newrelic.com > All capabilities](https://one.newrelic.com/all-capabilities) > Infrastructure > AWS**</DNT> and select one of the Redshift integration links.
