  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <DNT>**Process samples**</DNT> do not report these metrics:
        ...
        * I/O write count per second
          ...
          The following <DNT>**inventory sources**</DNT> are not reported:
...
<CollapserGroup>
  ...
  >
    To switch the running mode <DNT>**from root to privileged or unprivileged**</DNT>, follow the installation/update instructions in this doc.
  </Collapser>
  ...
  >
    To change the running mode <DNT>**from privileged or unprivileged to any other mode:**</DNT>
