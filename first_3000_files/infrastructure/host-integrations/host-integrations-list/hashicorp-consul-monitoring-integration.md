...
| **FAN_OUT** | If true will attempt to gather metrics from all other nodes in Consul
        cluster. | true | M |
| **CHECK_LEADERSHIP** | Check leadership on consul server. This should be disabled on consul in
        client mode. | true | M |
