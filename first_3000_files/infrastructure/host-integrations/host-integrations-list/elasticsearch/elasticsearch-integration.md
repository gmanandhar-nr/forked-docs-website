...
The Elasticsearch integration collects both Metrics and Inventory information. In the table, use the <DNT>**Applies to**</DNT> column for the settings available to each collection:
