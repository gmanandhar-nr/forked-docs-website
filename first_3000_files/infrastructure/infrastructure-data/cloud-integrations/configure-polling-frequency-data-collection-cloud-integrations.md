...
* <DNT>**Billing:**</DNT> If you need to manage your AWS CloudWatch bill, you may want to decrease the polling frequency. Before you do this, make sure that any [alert](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions) [conditions](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions) set for your cloud integrations are not affected by this reduction.
* <DNT>**New services:**</DNT> If you are deploying a new service or configuration and you want to collect data more often, you may want to increase the polling frequency temporarily.
...
3. Select <DNT>**Configure**</DNT> next to the integration.
4. Use the dropdowns next to <DNT>**Data polling interval every**</DNT> to select how frequently you want New Relic to capture your cloud integration data.
...
2. Select the tab that corresponds to your cloud service provider.
3. Select <DNT>**Configure**</DNT> next to the integration.
4. Under <DNT>**Data collections and filters**</DNT>, turn the toggles you want <DNT>**On**</DNT>.
...
When a filter is <DNT>**On**</DNT>, you specify the data that you want to be collected; for example, if the <DNT>**Limit to AWS region**</DNT> is <DNT>**On**</DNT>, the regions that you select will be the ones that data will be collected for. There are different filters available, depending on the integration:
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Select the regions that include the resources that you want to monitor. This option is exclusive for AWS.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Enter <DNT>**one**</DNT> tag key that is associated with the resources that you want to monitor. Filter values are case-sensitive, and you can use this filter in combination with <DNT>**tag value**</DNT> filter. Applicable for AWS and Azure only.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Enter <DNT>**one**</DNT> tag value that is associated with the resources that you want to monitor. Filter values are case-sensitive, and you can use this filter in combination with <DNT>**tag key**</DNT>. Applicable for AWS and Azure only.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Select the resource groups that are associated with the resources that you want to monitor. Applicable for AWS and Azure only.
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        When you create [alert conditions](/docs/infrastructure/new-relic-infrastructure/infrastructure-alert-conditions) after you set filters, make sure that your <InlinePopover type="alerts"/> are not triggered by resources that you filtered out.
      </td>
    </tr>
