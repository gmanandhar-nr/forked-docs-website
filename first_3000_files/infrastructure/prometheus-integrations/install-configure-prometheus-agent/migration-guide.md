...
* Prometheus Counter metrics without the name suffix `total`, `count`, `sum`, or `bucket` will be converted as <DNT>**Gauge**</DNT>.
* Prometheus Gauge metrics with the name suffix `total`, `count`, `sum`, or `bucket` will be converted as <DNT>**Counter**</DNT>.
