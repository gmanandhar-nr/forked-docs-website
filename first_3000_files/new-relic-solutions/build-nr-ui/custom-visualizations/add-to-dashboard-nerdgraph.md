...
Add your custom visualization to a new or existing dashboard, programmatically, with New Relic's GraphQL API, [NerdGraph](/docs/apis/nerdgraph/get-started/introduction-new-relic-nerdgraph/).
