...
Whether you're on the [original user model](/docs/accounts/original-accounts-billing/original-users-roles/users-roles-original-user-model/) or [our newer user model](/docs/accounts/accounts-billing/new-relic-one-user-management/new-relic-one-user-model-understand-user-structure/), review the tables below for a summary of your Nerdpack capabilities.

### Newer user model [#new-user-model]
...
If you're on our [original user model](/docs/accounts/original-accounts-billing/original-users-roles/overview-user-models), here's how you can interact with Nerdpacks:
...
<table>
  <thead>
    <tr>
      ...
      <th style="text-align:center">
        Core or full platform user without Nerdpack Manager add-on role
      </th>

      <th style="text-align:center">
        Core or full platform user with Nerdpack Manager add-on role
      </th>
...
There are a few Nerdlets that basic users are allowed to use. See [Basic users](#basic-users) for more information.

## Nerdpack permissions: Newer user model [#nerdpack-permissions]

Learn the differences between how basic users, full platform users, and core users on [our newer user model](/docs/accounts/original-accounts-billing/original-users-roles/overview-user-models) can use and manage Nerdpacks.
...
## Nerdpack permissions: Original user model [#nerdpack-permissions-original]

Learn the differences between how basic users, full users, core users, and admins on our [original user model](/docs/accounts/original-accounts-billing/original-users-roles/users-roles-original-user-model/) can use and manage Nerdpacks.

### Basic users [#basic-users-original]
...
### Core users and full platform users [#core-full-platform-users-original]
