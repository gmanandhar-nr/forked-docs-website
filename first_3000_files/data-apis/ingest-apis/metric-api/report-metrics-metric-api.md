...
<Callout variant="tip">
  ...
  For this API, the EU endpoint is:
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <DNT>**Required**</DNT>. The name of the metric. The value must be less than 255 characters.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DNT>**Required**</DNT>. The value varies depending on the [metric type](/docs/telemetry-data-platform/ingest-manage-data/understand-data/metric-data-type). For `gauge` and `count` the value should be a single number. For `summary`, the value should be a map with key-value pairs specifying the count, sum, min, and max.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <DNT>**Required for `count` and `summary` [metric types](/docs/telemetry-data-platform/ingest-manage-data/understand-data/metric-data-type)**</DNT>. The length of the time window.
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <DNT>**Required for `count` and `summary`.**</DNT>The length of the time window.
      </td>
    </tr>
