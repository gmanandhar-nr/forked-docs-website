...
| Multi query | When using the [`TIMESERIES`](/docs/query-data/nrql-new-relic-query-language/getting-started/nrql-syntax-clauses-functions#sel-timeseries) clause you can run and compare up to 10 queries from different accounts.
