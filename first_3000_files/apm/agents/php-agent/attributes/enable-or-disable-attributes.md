...
<CollapserGroup>
  ...
  >
    ...
    Turns on or turns off all attributes for <InlinePopover type="browser"/>. This is the data that gets attached to page view events. If `newrelic.attributes.enabled` is `false`, no attributes will be sent to browser monitoring regardless of how this property is set.
  </Collapser>
