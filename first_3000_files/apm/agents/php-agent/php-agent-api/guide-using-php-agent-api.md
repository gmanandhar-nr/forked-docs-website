...
* Organize and analyze your data on New Relic UI pages (for example, APM's [<DNT>**Applications index**</DNT> page](/docs/apm/applications-menu/monitoring/view-your-applications-index), the [<DNT>**Summary**</DNT> page](/docs/apm/applications-menu/monitoring/apm-overview-page), the [<DNT>**Transactions**</DNT> page](/docs/apm/applications-menu/monitoring/transactions-page), etc.).
