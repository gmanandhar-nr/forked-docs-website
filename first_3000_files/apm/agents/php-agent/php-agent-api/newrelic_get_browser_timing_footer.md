...
Returns a <InlinePopover type="browser"/> snippet to inject at the end of the HTML output.
...
<Callout variant="tip">
  Compare [`newrelic_disable_autorum()`](/docs/agents/php-agent/php-agent-api/newrelic_disable_autorum), which <DNT>**disables**</DNT> the browser monitoring script on a page.
</Callout>
