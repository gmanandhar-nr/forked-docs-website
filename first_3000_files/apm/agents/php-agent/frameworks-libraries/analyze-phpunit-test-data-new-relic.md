...
| - | - |
| `warningCount` | The number of tests with warnings. _Note that PHPUnit includes these in the `passedCount` as well._ |
| `failedCount` | The number of failed tests. |
