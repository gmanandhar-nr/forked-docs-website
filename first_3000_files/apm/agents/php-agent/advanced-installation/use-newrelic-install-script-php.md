...
<CollapserGroup>
  ...
  >
    Invoke install mode by using <DNT>**one**</DNT> of these methods:
  ...
  >
    At the prompt, enter your New Relic <InlinePopover type="licenseKey"/>. This key will be inserted into any INI files created during the rest of the installation process.
  </Collapser>
  ...
  >
    ...
    <DNT>**Example:**</DNT> The menu shows seven options:
  ...
  >
    After you install New Relic successfully and restart your web server, you can begin gathering data about your applications. After a few minutes, data will begin to appear on your [APM <DNT>**Summary**</DNT> page](/docs/apm/apm-ui-pages/monitoring/apm-summary-page-view-transaction-apdex-usage-data/).
