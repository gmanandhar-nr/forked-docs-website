...
Monitor your [New Relic for Go](/docs/agents/go-agent/get-started/new-relic-go) application or microservice by creating [transactions](/docs/apm/transactions/intro-transactions/transactions-new-relic-apm) associated with specific app server activities, such as HTTP responses or background tasks. You can then view your app's performance in the New Relic, including the [APM <DNT>**Transactions**</DNT> page](/docs/apm/applications-menu/monitoring/transactions-page).
...
You can also see logs in context of your [infrastructure data](/docs/logs/forward-logs/forward-your-logs-using-infrastructure-agent/), such as Kubernetes clusters. No need to switch to another UI.
