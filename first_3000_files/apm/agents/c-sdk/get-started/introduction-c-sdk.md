...
<Callout
  ...
  title="EOL NOTICE"
>
  From April 2022, we don't support the C SDK capability. Please explore the [option to use OpenTelemetry](https://opentelemetry.io/docs/languages/cpp/getting-started/) as an alternative to send C++ telemetry data to New Relic. For more details about the EOL, see our [Support Forum post](https://discuss.newrelic.com/t/q1-bulk-eol-announcement-fy23/181744).
</Callout>
...
2. If you don't already have one, [sign up for a free New Relic account](https://newrelic.com/signup).
...
<figcaption>
  <DNT>**C SDK architecture:**</DNT> To send data from your application to New Relic, the daemon must be invoked <DNT>**before**</DNT> making calls to your application's C SDK instrumentation library.
</figcaption>
