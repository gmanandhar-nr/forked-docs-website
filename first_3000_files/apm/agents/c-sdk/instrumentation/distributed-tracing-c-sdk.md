...
<Callout variant="tip">
  ...
  * [Impacts to APM](/docs/apm/distributed-tracing/getting-started/transition-guide-distributed-tracing) tells you what to expect if you are a current <InlinePopover type="apm"/> user but haven't set up distributed tracing.
</Callout>
