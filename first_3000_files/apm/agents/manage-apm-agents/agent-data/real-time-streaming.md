...
3. For applicable queries, hover over the query and click <DNT>**Edit in query builder**</DNT> to refine your query.
...
* <DNT>**Go:**</DNT> [v2.8.0 or higher](/docs/release-notes/agent-release-notes/go-release-notes)
* <DNT>**Java:**</DNT> [v5.5.0 or higher](/docs/release-notes/agent-release-notes/java-release-notes)
* <DNT>**.NET:**</DNT> [v8.23.107.0 or higher](/docs/release-notes/agent-release-notes/net-release-notes)
* <DNT>**Node.js:**</DNT> [v5.13.0 or higher](/docs/release-notes/agent-release-notes/nodejs-release-notes)
* <DNT>**PHP:**</DNT> [v9.5.0.252 or higher](/docs/release-notes/agent-release-notes/php-release-notes)
* <DNT>**Python:**</DNT> [v5.2.0.127 or higher](/docs/release-notes/agent-release-notes/python-release-notes)
* <DNT>**Ruby:**</DNT> [v6.7.0.359 or higher](/docs/release-notes/agent-release-notes/ruby-release-notes)
