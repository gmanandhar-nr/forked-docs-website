...
For example, if you set the deployment marker and ran the script to push 100 instances of the app, the <DNT>**Deployments**</DNT> page will show one deployment for the 100 instances. If you ran the script again, it would show another deployment.
