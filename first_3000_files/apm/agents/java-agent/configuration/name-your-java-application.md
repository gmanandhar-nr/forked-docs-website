...
For a general overview of <InlinePopover type="apm"/> app naming (not Java-specific), see [Name your application](/docs/agents/manage-apm-agents/app-naming/name-your-application).
