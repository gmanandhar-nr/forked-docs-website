...
1. Go to the [.NET agent download site](https://download.newrelic.com/dot_net_agent/latest_release/) and get the file matching your application's architecture (64-bit or 32-bit):
...
* <DNT>**License key**</DNT>. The environment variable for setting the <InlinePopover type="licenseKey"/> is:
...
* <DNT>**App name**</DNT>. Setting a [meaningful application name](/docs/agents/manage-apm-agents/app-naming/name-your-application#app-name) is recommended, but you can also set this after install. The environment variable is:
       ...
       <table>
         ...
         <tbody>
           <tr>
             ...
             <td>
               <DNT>**Required**</DNT>. The location where the agent is installed. This can be an absolute or relative path. Wrapping quotes are required.
             </td>
           </tr>
           ...
           <tr>
             ...
             <td>
               <DNT>**Required**</DNT>. Determines whether this is a local (app-specific) or global (system-wide) install.
             </td>
           </tr>
           ...
           <tr>
             ...
             <td>
               Optional. Installs the 32-bit version of the agent rather than the 64-bit version. New Relic <DNT>**does not recommend**</DNT> installing the 32-bit version of the agent globally.
             </td>
           </tr>
