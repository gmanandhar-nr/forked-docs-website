...
<DNT>**Exception:**</DNT> For conflicts with Microsoft's System Center Operations Manager (SCOM), follow the [troubleshooting procedures specifically for SCOM](/docs/agents/net-agent/troubleshooting/resolve-net-scom-conflicts).
...
<CollapserGroup>
  ...
  >
    ...
    1. Run <DNT>**Process Explorer**</DNT> as an Administrator.
    2. To find your app's process, right-click the app, then select <DNT>**Properties > Environment**</DNT>.
