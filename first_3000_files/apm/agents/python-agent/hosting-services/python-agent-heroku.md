...
<CollapserGroup>
  ...
  >
    ...
    2. From <DNT>**Select an app**</DNT>, select your New Relic app.
...
To install a third party Python package such as our Python agent on Heroku, use <DNT>**pip**</DNT>. Heroku automatically looks for a <DNT>**requirements.txt**</DNT> file in the root directory of your project. It installs anything listed in that file when you push your project to Heroku.
...
1. Create or edit the `requirements.txt` file, adding the line:
   ...
   newrelic
   ```
2. <DNT>**Django users:**</DNT> Modify the `web` entry of your `Procfile`, prefixing the value with `newrelic-admin run-program`. For example:
...
The <InlinePopover type="licenseKey"/> is unique to your New Relic account.
...
<Callout variant="caution">
  ...
  The WSGI host using the <DNT>**wsgiref**</DNT> module was not fully WSGI compliant for development hosts prior to Python version 2.7.4. This prevented the Python agent from being able to report correct data.
</Callout>
