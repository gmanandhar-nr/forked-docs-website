...
* Fixes [#301](https://github.com/newrelic/newrelic-dotnet-agent/issues/301) where the agent incorrectly parses server-side configuration causing agent to shutdown.[#310](https://github.com/newrelic/newrelic-dotnet-agent/pull/310)
