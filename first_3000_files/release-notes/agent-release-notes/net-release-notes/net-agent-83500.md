...
* **.NET 5 GA Support**  
  We have validated that this version of the agent is compatible with .NET 5 GA. See the [compatibility and requirements for .NET Core](/docs/apm/agents/net-agent/configuration/net-agent-configuration/) page for more details.
