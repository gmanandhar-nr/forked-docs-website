...
New Relic tools and features, like APM, infrastructure monitoring, <InlinePopover type="browser"/>, and alerts, are often used together, and sometimes can overlap in functionality. This is why multiple APIs may be relevant to each area. Some API functionality will depend on your [access to features and data](/docs/accounts/accounts-billing/general-account-settings/factors-affecting-access-features-data).
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Every <InlinePopover type="apm"/> language agent has an API that lets you customize the agent's default behavior, including reporting custom data. APM agent APIs include:
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>
            Our mobile SDK allows you to custom instrument your own code and send events to New Relic. See [Mobile SDK guide](/docs/mobile-monitoring/new-relic-mobile/mobile-sdk/mobile-sdk-api-guide) to get started.
          </td>
        </tr>
